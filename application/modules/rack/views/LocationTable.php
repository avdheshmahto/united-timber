...
<button class="btn btn-default modalEditItem" property="view" attr='<?php echo json_encode($fetch_list)?>' onclick="editlocation(this);" href='#editlocation' type="button" data-toggle="modal" data-backdrop='static' data-keyboard='false'> <i class="fa fa-eye"></i> </button>

<?php } if($edit!=''){ ?>

<button class="btn btn-default modalEditItem" property="edit" attr='<?php echo json_encode($fetch_list)?>' onclick="editlocation(this);" href='#editlocation' type="button" data-toggle="modal" data-backdrop='static' data-keyboard='false'><i class="icon-pencil"></i></button>

<?php }
$pri_col='serial_number';
$table_name='tbl_master_data';
?>
<button class="btn btn-default delbutton" id="<?php echo $fetch_list->serial_number."^".$table_name."^".$pri_col ; ?>" type="button"><i class="icon-trash"></i></button>		
<?php
 $i++;
 }
  ?>
