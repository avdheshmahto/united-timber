...
<div class="col-lg-12">
  <div class="panel panel-default">
    ...
    <label>&nbsp; &nbsp;&nbsp; &nbsp;Show
    <select name="DataTables_Table_0_length" url="<?=base_url();?>report/Report/machine_report?<?='m_type='.$_GET['m_type'].'&machineid='.$_GET['machineid'].'&filter='.$_GET['filter'];?>" aria-controls="DataTables_Table_0" id="entries" class="form-control input-sm">
        ...
        <table class="table table-striped table-bordered table-hover dataTables-example1" id="loadData">
          ...
          <tbody id="getDataTable" >
            ...
            <tr class="gradeC record">
              <th><?php echo $z++; ?></th>
              <th><a href="<?=base_url();?>report/Report/machine_details_report?sid=<?=$fetch->id?>"><?php echo $fetch->name; ?></a></th>
