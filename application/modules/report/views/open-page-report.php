            ...
            <div class="row gap-0">
              <div class="col-xs-12 col-sm-2"  style="padding:0px;">
                <div class="step-item active">
                  <a href="<?=base_url();?>report/Report/comparison_report">
                    <div class="line"></div>
                    <div class="step-item">
                      <div class="number">
              ...
              <div class="col-xs-12 col-sm-2"  style="padding:0px;">
                <div class="step-item active">
                  <a href="<?=base_url();?>report/Report/machine_report">
                    <div class="line"></div>
                    <div class="step-item">
                      <div class="number">
              ...
              <div class="col-xs-12 col-sm-2"  style="padding:0px;">
                <div class="step-item active">
                  <a href="<?=base_url();?>report/Report/section_report">
                    <div class="line"></div>
                    <div class="step-item">
                      <div class="number">
              ...
              <div class="col-xs-12 col-sm-2"  style="padding:0px;">
                <div class="step-item active">
                  <a href="<?=base_url();?>report/Report/breakdown_hours_report">
                    <div class="line"></div>
                    <div class="step-item">
                      <div class="number">
                        <div class="inner">4</div>
                      </div>
                      <p>Breakdown Hours Report</p>
                    </div>
                  </a>
                </div>
              </div>
              <div class="col-xs-12 col-sm-2" style="padding:0px;">
                <div class="step-item active">
                  <a href="<?=base_url();?>report/Report/currentStock">
                    <div class="line"></div>
                    <div class="step-item">
                      <div class="number">
              ...
              <div class="col-xs-12 col-sm-2"  style="padding:0px;">
                <div class="step-item active">
                  <a href="<?=base_url();?>report/Report/searchReorderLevel">
                    <div class="line"></div>
                    <div class="step-item">
                      <div class="number">
              ...
              <div class="col-xs-12 col-sm-2"  style="padding:0px;">
                <div class="step-item active">
                  <a href="<?=base_url();?>report/Report/searchBincard">
                    <div class="line"></div>
                    <div class="step-item">
                      <div class="number">
              ...
              <div class="col-xs-12 col-sm-2"  style="padding:0px;">
                <div class="step-item active">
                  <a href="<?=base_url();?>report/Report/spare_return">
                    <div class="line"></div>
                    <div class="step-item">
                      <div class="number">
              ...
              <div class="col-xs-12 col-sm-2"  style="padding:0px;">
                <div class="step-item active">
                  <a href="<?=base_url();?>report/Report/machine_spare_report">
                    <div class="line"></div>
                    <div class="step-item">
                      <div class="number">
                        <div class="inner">9</div>
                      </div>
                      <p>Machine To Spare Report</p>
                    </div>
                  </a>
                </div>
              </div>
              <div class="col-xs-12 col-sm-2"  style="padding:0px;">
                <div class="step-item active">
                  <a href="<?=base_url();?>report/Report/spare_machine_report">
                    <div class="line"></div>
                    <div class="step-item">
                      <div class="number">
                        <div class="inner">10</div>
                      </div>
                      <p>Spare To Machine Report</p>
                    </div>
                  </a>
                </div>
              </div>
