            ...
            <table class="table table-striped table-bordered table-hover dataTables-example1">
              ...
              <tbody>
                ...
                <th>
                  ...
                  <a target="_blank" href="<?=base_url('report/Report/frequency_details_machine?id=')?><?=$getWO->id?>&year=<?=$_GET['year']?>&month=<?=$_GET['month']?>&from_date=<?=$_GET['from_date']?>&to_date=<?=$_GET['to_date']?>&spare_type=<?=$_GET['spare_type']?>&spare_id=<?=$_GET['spare_id']?>&filter=<?=$_GET['filter']?>" style="font-size: small;">
                  Frequncy Of Spares</a>
                <?php  } else { ?>
                  <a target="_blank" href="<?=base_url('report/Report/frequency_details_machine?id=')?><?=$getWO->id?>&year=<?=$_GET['year']?>&month=<?=$_GET['month']?>" style="font-size: small;">
                  Frequncy Of Spares</a>
                <?php } ?>
                </th>
                <th></th>
              ...
              <tbody id="getDataTable" >
                ...
                if($_GET['filter'] == 'filter')
                {
                  ...
                  $qry="select * from tbl_software_cost_log where machine_id='".$_GET['id']."' AND log_type!='Labour' ";
                ...
                else
                {
                  ...
                  $qry="select * from tbl_software_cost_log where machine_id='".$_GET['id']."' AND log_type!='Labour' AND EXTRACT(MONTH FROM log_date)='".$_GET['month']."' AND EXTRACT(YEAR FROM log_date)='".$_GET['year']."' "; 
                ...
                <tr class="gradeC record">
                  ...
                  <?php 
                    $lbr=$this->db->query("select *,SUM(total_spent) as labourcost from tbl_software_cost_log where log_type='Labour' AND machine_id='".$_GET['id']."' AND EXTRACT(MONTH FROM log_date)='".$_GET['month']."' AND EXTRACT(YEAR FROM log_date)='".$_GET['year']."' ");
                    $getLbr=$lbr->row();
...
<script type="text/javascript">
  ...
  function ResetLead()
  {
    location.href="<?=base_url('/report/Report/comparison_machine_spares?id=');?><?=$_GET['id']?>&year=<?=$_GET['year']?>&month=<?=$_GET['month']?>";
  }
