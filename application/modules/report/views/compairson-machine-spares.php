      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
          <?php 
            ...
            $getWO=$wo->row(); ?>
          <h4 class="panel-title">COMPARISON MACHINE SPARE DETAILS (<?php echo $getWO->machine_name; ?>) </h4>
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example1">
              ...
              <tbody>
                ...
                <th>
                  ...
                  <a href="<?=base_url('report/Report/frequency_details_machine?sid=')?><?=$_GET['sid']?>&mid=<?=$_GET['mid']?>&year=<?=$_GET['year']?>&month=<?=$_GET['month']?>&from_date=<?=$_GET['from_date']?>&to_date=<?=$_GET['to_date']?>&spare_type=<?=$_GET['spare_type']?>&spare_id=<?=$_GET['spare_id']?>&filter=<?=$_GET['filter']?>" style="font-size: small;">
                  Frequncy Of Spares</a>
                <?php  } else { ?>
                  <a href="<?=base_url('report/Report/frequency_details_machine?sid=')?><?=$_GET['sid']?>&mid=<?=$_GET['mid']?>&year=<?=$_GET['year']?>&month=<?=$_GET['month']?>" style="font-size: small;">
                  Frequncy Of Spares</a>
                <?php } ?>
                </th>
                <th></th>
              ...
              <tbody id="getDataTable" >
                ...
                if($_GET['filter'] == 'filter')
                {
                  ...
                  $qry="select * from tbl_software_cost_log where main_section='".$_GET['sid']."' AND machine_id='".$_GET['mid']."' AND log_type!='Labour' ";
                ...
                else
                {
                  ...
                  $qry="select * from tbl_software_cost_log where main_section='".$_GET['sid']."' AND machine_id='".$_GET['mid']."' AND log_type!='Labour' AND EXTRACT(MONTH FROM log_date)='".$_GET['month']."' AND EXTRACT(YEAR FROM log_date)='".$_GET['year']."' "; 
                ...
                <tr class="gradeC record">
                  ...
                  <?php 
                    $lbr=$this->db->query("select *,SUM(total_spent) as labourcost from tbl_software_cost_log where log_type='Labour' AND machine_id='".$_GET['mid']."' AND EXTRACT(MONTH FROM log_date)='".$_GET['month']."' AND EXTRACT(YEAR FROM log_date)='".$_GET['year']."' ");
                    $getLbr=$lbr->row();
...
<script type="text/javascript">
  ...
  function ResetLead()
  {
    location.href="<?=base_url('/report/Report/comparison_machine_spares?sid=');?><?=$_GET['sid']?>&mid=<?=$_GET['mid']?>&year=<?=$_GET['year']?>&month=<?=$_GET['month']?>";
  }
