          ...
          <tbody id="getDataTable" >
            <?php
              if($_GET['filter'] == 'filter') 
              {
                ...
                $qry ="select *,COUNT(product_id) as frequncyofspares from tbl_software_cost_log where section_id='".$_GET['id']."' AND machine_id='' AND log_type!='Labour'";
              ...
              else
              {
                ...
                $qry="select *,COUNT(product_id) as frequncyofspares from tbl_software_cost_log where section_id='".$_GET['id']."' AND machine_id='' AND log_type!='Labour' AND EXTRACT(MONTH FROM log_date)='".$_GET['month']."' AND EXTRACT(YEAR FROM log_date)='".$_GET['year']."' GROUP BY product_id";  
