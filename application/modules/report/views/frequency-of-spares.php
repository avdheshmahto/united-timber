...
$getWO=$wo->row(); ?>
<h4 class="panel-title">FREQUENCY OF SPARES (<?php echo $getWO->machine_name; ?>) </h4>	
</div>
...
<?php
$sftcostlog=$this->db->query("select *,COUNT(product_id) as frequncyofspares from tbl_software_cost_log where machine_id='".$_GET['id']."' AND log_type!='Labour' GROUP BY product_id");
