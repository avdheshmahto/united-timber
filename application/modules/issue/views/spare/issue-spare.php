<div class="modal-content">
  <div class="modal-header">
    ...
    <h4 class="modal-title">PARTS & SUPPLIES ISSUE</h4>
  </div>
</div>
...
<tr>    
  ...
  <td>
    <input type="number" name="spare_qty[]" id="spare_qty<?php echo $z;?>" onkeyup="qtyfunction(this.id);" class="form-control" value="0">
  </td>    
</tr>
