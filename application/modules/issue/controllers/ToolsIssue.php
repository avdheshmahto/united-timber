...
function insert_tools_issue()
{
	...
	$this->db->query("insert into tbl_tools_issue_hdr set section='$section',maker_id='$maker_id',author_id='$author_id',comp_id='$comp_id',divn_id='$divn_id',zone_id='$zone_id', brnh_id='$brnh_id', maker_date='$maker_date', author_date='$author_date'");
	...
	for($i=0;$i<$rows;$i++)
	{
		...
		$this->add_software_cost_log($lastId,'Tools',$section,$machineid,'',$total_spent);
