...
class model_master extends CI_Model
{
    ...
    {
        $this->db->select("*")->from("tbl_product_serial")->where("status", 'A')->where("product_id", $_GET['id']);
    ...
    function getPartsWarrantyData()
    {
        ...
        $this->db->select("*")->from("tbl_machine_warranty")->where("module_type", 'Parts_Supplies')->where("warranty_log_id", $_GET['id']);
