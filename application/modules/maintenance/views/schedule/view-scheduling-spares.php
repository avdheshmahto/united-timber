<?php
$scheduleQuery=$this->db->query("select * from tbl_schedule_triggering where trigger_code='$id'");
$getSchedule=$scheduleQuery->row();
?>
<div class="modal-content">
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
<h4 class="modal-title">View Work Order Parts And Supplies </h4>
</div>
</div>
...
<table class="table table-striped table-bordered table-hover">
	   ...
	   <tbody>
	   		<tr class="gradeA">
				<th colspan="6"><center>Parts And Supplies List</center></th>
			</tr>
			<tr class="gradeA">
				<th>&nbsp;</th>
				<th>S.No.</th>
	...
	<?php
	$i=1;
		$smspareQuery=$this->db->query("select * from tbl_schedule_spare_hdr where trigger_code='$id'");
		$getsmspare=$smspareQuery->row();

		$smsparelogQuery=$this->db->query("select * from tbl_schedule_spare_dtl where smsparetrigger_hdr_id='$getsmspare->id'");
