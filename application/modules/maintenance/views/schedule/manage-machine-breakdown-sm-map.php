...
$i=1;
$spareq=$this->db->query("select * from tbl_workorder_spare_hdr where work_order_id='".$_GET['id']."' and type = 'Parts'");
...
<?php
 $triggerlog=$this->db->query("select * from tbl_schedule_triggering_log where trigger_code='$getsched->trigger_code' and status = 'A'");
...
<!-- ======================================= Add Spare =============================== -->
<div id="schedulespareid" class="modal fade modal" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-contentMap" id="modal-contentMap">
			<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			...
			<form id="formscheduleparts" method="post">
				<table class="table table-striped table-bordered table-hover" >
					<tbody>
...
<!-- ======================================= Add Tools =============================== -->
<div id="scheduletoolsid" class="modal fade modal" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-contentMap" id="modal-contentMap">
			<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			<h4 class="modal-title">Add Tools</h4>
			<div id="resultareatoolss" class="text-center " style="font-size: 15px;color: red;"></div> 
			<form id="formtoolschedule" method="post">
				<table class="table table-striped table-bordered table-hover">
							<input type="hidden" name="tools_workorder_id" value="<?php echo $_GET['id'];?>">
...
<div id="viewschedulepartsid" class="modal fade modal" role="dialog">
    <div class="modal-dialog modal-lg">
	
        <div class="modal-parts-order" id="modal-parts-order">
...
<form class="form-horizontal" role="form"  enctype="multipart/form-data">			
<div id="viewscheduletoolsid" class="modal fade modal" role="dialog">
    <div class="modal-dialog modal-lg">
	
        <div class="modal-schedule-tools" id="modal-schedule-tools">
...
function viewscheduleparts(v){
//alert(v);
var pro=v;
 var xhttp = new XMLHttpRequest();
 
  xhttp.open("GET", "<?=base_url()?>maintenance/schedule/view_schedule_parts?ID="+pro, false);
  xhttp.send();
  //alert(xhttp.responseText);
  document.getElementById("modal-parts-order").innerHTML = xhttp.responseText;
 } 	

 function viewscheduletools(v){
//alert(v);
var pro=v;
 var xhttp = new XMLHttpRequest();
 
  xhttp.open("GET", "<?=base_url()?>maintenance/schedule/view_schedule_tools?ID="+pro, false);
  xhttp.send();
  
  document.getElementById("modal-schedule-tools").innerHTML = xhttp.responseText;
 } 	
...
function submitworkorderfilesupload() 
{
	...
	$.ajax({
		      url: "<?=base_url();?>maintenance/schedule/insert_schedule_files",
		      type: "POST",
		      data: form_data,
...
{
	//alert(production_id);
 	ur = "<?=base_url();?>maintenance/schedule/get_schedule_files";
    $.ajax({
			url: ur,
