<?php
$scheduleQuery=$this->db->query("select *from tbl_workorder_spare_hdr where spare_hdr_id='$id' AND type='Tools' ");
$getSchedule=$scheduleQuery->row();
?>
<div class="modal-content">
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
<h4 class="modal-title">View Tools (<?=sprintf('%03d',$id); ?>)</h4>
</div>
</div>
...
<table class="table table-striped table-bordered table-hover">
				  <tbody>
			   		<tr class="gradeA">
						<th colspan="5"><center>Tools List</center></th>
					</tr>
					<tr class="gradeA">
			...
			?>
					<tr class="gradeA">
						...
						<th><?php echo $getSmlog->issue_qty;?></th>
